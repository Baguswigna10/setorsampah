...
INSERT IGNORE INTO waste_categories (name, point_per_kg, description) VALUES
('Plastik', 5.0, 'Sampah plastik jenis botol dan kantong'),
('Kertas', 3.0, 'Kertas bekas, koran, majalah'),
('Logam', 8.0, 'Logam ringan seperti kaleng dan tutup botol');
